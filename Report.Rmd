...
Higher scores on the CDRSB, FAQ, ADASQ4, and TRABSCOR are associated with higher odds of conversion to dementia. While higher education and higher scores on immediate and delayed recall are associated with lower odds of conversion. A Random Forest and Neural Network was used for sensitivity analysis with Random Forest performing better than Neural Network by 3% to 4%. 
